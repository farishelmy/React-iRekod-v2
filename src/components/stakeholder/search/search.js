...
class search extends Component {
    ...
    render() {
        ...
        const {stakeholderlistType}=this.state       
        const {basicKey,stakehlist,searchStatus} = this.props.searchConf       
                        ...
                        <div className="d-flex bd-highlight">
                            ...
                            <div className="row">    
...

                                {
                                    ...
                                    stakeholderlistType.filter(x => _.toUpper(x.Name).includes(_.toUpper(basicKey||""))).map((item)=>stakehView?
