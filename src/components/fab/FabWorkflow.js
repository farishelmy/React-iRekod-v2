...
const sendActive=(e)=>{
    e.preventDefault()
    FabRec(e.target.name, e.target.getAttribute("name2"))
}
        ...
        <span className="fab-action-button">
            <Tooltip
                ...
                arrowContent={<div className="rc-tooltip-arrow-inner"></div>}
                 >
                 <img name="viewWorkflow" name2="viewAct" src={require('../../img/fab-update.svg')} alt='view' className='img-fluid' onClick={sendActive}   />
            </Tooltip>
        </span>
