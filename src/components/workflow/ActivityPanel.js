...
import { activityUri, activityName, setShowFab, getDetails, checkResult } from '../../actions/activityAction/listActivity/listActivityAction'
...
class ActivityPanel extends Component {
    ...
    componentDidUpdate(prevProps){
        if(prevProps.listActivity.activityStatus !== this.props.listActivity.activityStatus){           
            const {activityStatus}=this.props.listActivity 
